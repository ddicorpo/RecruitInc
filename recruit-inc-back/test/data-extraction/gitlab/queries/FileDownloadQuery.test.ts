...
describe('File download query class', function () {
    it('should return the correct query after building it', function () {
        ...
        let fileDownloadQuery: FileDownloadQuery = new FileDownloadQuery(projectId, fileSha1, gitlabFileDownloadQueryExecutor);

        fileDownloadQuery.buildQuery();
        let expected: string = fileDownloadQuery.getQuery();
        let actual: string =  "https://gitlab.com/api/v4/projects/1234/repository/blobs/abcde/raw";
...
describe('Retrieving the contents of a file', () => {
    ...
    it('should download a file', async function() {
        ...
        .get('/api/v4/projects/397775/repository/blobs/18f9b2da52f2d3185a676b0ce2c2639557560de3/raw')
