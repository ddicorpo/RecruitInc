...
describe('GithubToken class', function () {
    it('Should build the param string properly', function () {
        ...
        let actual: string =  "https://github.com/login/oauth/access_token?client_id=1908c6dc58ef2187341f&client_secret=6bfae547289c1d3da3fa37df655d4aa02502b9ad&code=123";
