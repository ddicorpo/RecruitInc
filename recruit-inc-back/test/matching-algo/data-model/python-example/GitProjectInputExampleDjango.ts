...
const singleCommitRequirements: ISingleFileCommit = {
...
const pathToFakePackageJson: string =
  __dirname + '/../files-downloaded/package.downloaded.json';
const pathToFakeGitIgnore: string =
  __dirname + '/../files-downloaded/gitignore.downloaded';
const pathToFakeRequirementsTxt: string =
  __dirname + '/../files-downloaded/requirements.downloaded.txt';
...
const gitIgnoreSourceFile: ISourceFiles = {
  ...
  fileContents: fs.readFileSync(pathToFakeGitIgnore, 'utf8'),
};

const requirementsSourceFIle: ISourceFiles = {
  filename: 'requirements.txt',
  repoFilePath: 'requirements.txt',
  fileContents: fs.readFileSync(pathToFakeRequirementsTxt, 'utf8'),
};
