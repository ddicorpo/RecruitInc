...
describe('Test react matching algorithm', () => {
  ...
  it('Should return the correct output object with bug-test repository', () => {
    // GIVEN
  ...
  it('Should return the correct output object with circleciprisma repository', () => {
    // GIVEN
  ...
  it('Should return the correct output object with codebuddy-fs repository', () => {
    // GIVEN
  ...
  it('Should return the correct output object with date-facts repository', () => {
    // GIVEN
  ...
  it('Should return the correct output object with droplr-clone repository', () => {
    // GIVEN
  ...
  it('Should return the correct output object with g-harel-github repository', () => {
    // GIVEN
  ...
  it('Should return the correct output object with jest repository', () => {
    // GIVEN
  ...
  it('Should return the correct output object with kankan repository', () => {
    // GIVEN
  ...
  it('Should return the correct output object with pc repository', () => {
    // GIVEN
  ...
  it('Should return the correct output object with pineapplol repository', () => {
    // GIVEN
  ...
  it('Should return the correct output object with react-ecommerce repository', () => {
    // GIVEN
  ...
  it('Should return the correct output object with rickety repository', () => {
    // GIVEN
  ...
  it('Should return the correct output object with sekstant repository', () => {
    // GIVEN
