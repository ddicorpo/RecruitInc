...
const client_secret: string = "a692c84ab5d9b94e1a67294c2360f00195d5200195a2cc1b9c3d537d11cc2c66";
...
export class GitlabToken {
    ...
    async getToken(code: string) {
        ...
        let params: string = `${"?client_id="+client_id+"&client_secret="+client_secret+"&code="+code+"&grant_type=authorization_code&redirect_uri="+redirectUrl}`;
