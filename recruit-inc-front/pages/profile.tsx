    ...
    render(){
        return (
            <div>
                ...
                <br/>
                <a style={{display: "table-cell"}} href={"https://gitlab.com/oauth/authorize?client_id=cf78ad0e83e8c8f5e4cc8b60ef0250e1d1a299cd9f3ec91ec9d54399eb52e102&redirect_uri=http://localhost:3000/profile?platform=gitlab&response_type=code"}>
                    Gitlab
                </a>
